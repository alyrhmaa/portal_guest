        ...
        <div class="row text-center">
            <div class="col-12">
                <h1 class="fw-bold mb-2">
                    <i class="bi bi-person-circle me-2"></i>Portal Desa
                </h1>
            </div>
        </div>
    </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="email" name="email" class="form-control rounded-3 border-pink" required>
                        </div>

                        <div class="mb-4">
                            <label for="password" class="form-label fw-semibold text-pink">Password</label>
                            <input type="password" id="password" name="password" class="form-control rounded-3 border-pink" required>
                        </div>

                        <button type="submit" class="btn btn-pink text-white w-100 fw-semibold rounded-3 py-2">
                    ...
                    <p class="text-center mt-4 mb-0 text-muted">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="text-decoration-none fw-semibold text-pink">
                            Daftar di sini
                        </a>
                    </p>
                </div>
