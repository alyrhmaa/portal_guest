        ...
        <div class="kategori-card">
            ...
            <div class="card-footer">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('kategori.edit', $kat->kategori_id) }}" class="btn btn-sm btn-primary">✏️ Edit</a>
                    <a href="{{ route('kategori.hapus', $kat->kategori_id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus kategori ini?')">🗑️ Hapus</a>
                </div>
            </div>
        </div>
        @endforeach
...
<style>
    ...
    .kategori-card:nth-child(2) { animation-delay: 0.1s; }
    .kategori-card:nth-child(3) { animation-delay: 0.2s; }
    .kategori-card:nth-child(4) { animation-delay: 0.3s; }
    .kategori-card:nth-child(5) { animation-delay: 0.4s; }
    .kategori-card:nth-child(6) { animation-delay: 0.5s; }
    .kategori-card:nth-child(7) { animation-delay: 0.6s; }
    .kategori-card:nth-child(8) { animation-delay: 0.7s; }
</style>
